...
import { Typography, Box, Card, Chip, Alert, CircularProgress, Table } from '@mui/joy';
...
const SeasonalReportViewerModal = ({ open, onClose, seasonalReportId, item, onSuccess }) => {
  ...
  return (
    <WorkflowFormShell open={open} onClose={onClose} submitting={submitting} size="md">
      <ModalLayoutShell
        context={
          <ContextRegion
            title={`Seasonal Report — #${seasonalReportId}`}
